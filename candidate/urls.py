...
urlpatterns = [
    ...
    path('job/<slug>/apply/', views.ApplyTheGivenJobView.as_view(), name='apply-job'),
    path('job/<slug>/save/', views.SaveTheGivenJobView.as_view(), name='save-job'),
    ...
    path('job/<slug>/remove/', views.RemoveTheGivenJobView.as_view(), name='remove-job'),
]
